...
echo "  - Расписание: Каждое воскресенье в 2:00 ночи"
...
# Добавление в crontab (каждое воскресенье в 2:00)
CRON_COMMAND="0 2 * * 0 $SCRIPT_PATH >> $LOG_FILE 2>&1"
...
(
    echo "$CURRENT_CRON"
    echo ""
    echo "# Zabbix → NetBox синхронизация (каждое воскресенье в 2:00)"
    echo "$CRON_COMMAND"
) | crontab -
...
crontab -l
echo ""
echo "📅 Следующий запуск будет в ближайшее воскресенье в 2:00 ночи"
echo ""
